    ...
    function upBubbel() {
        ...
        //气泡的数量
        var i, bubblesNumber = w * h > 750000 ? 140 : 80,
            objects = [],
        //气泡的最大半径
            maxRadius = 6,
        //最大上升速度（y轴的移动位移）
        ...
        for (i = 0; i < bubblesNumber; i++) {
            objects.push(new Bubble(Math.random() * w, Math.random() * h, -randomInRange(0.5, maxYVelocity), randomInRange(4, maxRadius), randomInRange(7, 10), randomInRange(-40, 40), randomInRange(0, 360)));
        }
